...
<script>
    ...
    {
        ?>
    wsUrl='ws://<?php echo $_SERVER['SERVER_ADDR']; ?>:8080';
    <?php
    }
    else
    {
...
<section  data-ng-style='containerStyle' data-ng-class="containerClass" class="animated main-container" data-ng-view>
</section>
    <?php
}
catch (Exception $e)
